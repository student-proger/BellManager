...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.spinBox.setGeometry(QtCore.QRect(260, 140, 51, 22))
        self.spinBox.setMinimum(1)
        self.spinBox.setMaximum(30)
        self.spinBox.setObjectName("spinBox")
        self.spinBox_2 = QtWidgets.QSpinBox(self.tab_2)
        self.spinBox_2.setGeometry(QtCore.QRect(260, 170, 51, 22))
        self.spinBox_2.setMinimum(1)
        self.spinBox_2.setMaximum(30)
        self.spinBox_2.setObjectName("spinBox_2")
        self.label_15 = QtWidgets.QLabel(self.tab_2)
        self.label_15.setGeometry(QtCore.QRect(10, 170, 251, 16))
        self.label_15.setObjectName("label_15")
        self.label_13 = QtWidgets.QLabel(self.tab_2)
        self.label_13.setGeometry(QtCore.QRect(10, 140, 181, 16))
        self.label_13.setObjectName("label_13")
        self.autoStartCheckbox = QtWidgets.QCheckBox(self.tab_2)
        self.autoStartCheckbox.setGeometry(QtCore.QRect(310, 20, 201, 17))
        self.autoStartCheckbox.setObjectName("autoStartCheckbox")
        self.autoOnNewDayCheckbox = QtWidgets.QCheckBox(self.tab_2)
        self.autoOnNewDayCheckbox.setGeometry(QtCore.QRect(310, 50, 371, 17))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(680, 110, 321, 191))
        ...
        self.logCheckBox.setGeometry(QtCore.QRect(310, 80, 211, 17))
        self.logCheckBox.setObjectName("logCheckBox")
        self.groupBox_3 = QtWidgets.QGroupBox(self.tab_2)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 200, 651, 141))
        self.groupBox_3.setObjectName("groupBox_3")
        self.notifyBeforeRing = QtWidgets.QCheckBox(self.groupBox_3)
        self.notifyBeforeRing.setGeometry(QtCore.QRect(10, 20, 131, 17))
        self.notifyBeforeRing.setObjectName("notifyBeforeRing")
        self.notify5 = QtWidgets.QLineEdit(self.groupBox_3)
        self.notify5.setGeometry(QtCore.QRect(70, 80, 201, 20))
        self.notify5.setObjectName("notify5")
        self.browseNotifyFile5 = QtWidgets.QPushButton(self.groupBox_3)
        self.browseNotifyFile5.setGeometry(QtCore.QRect(270, 80, 41, 20))
        self.browseNotifyFile5.setObjectName("browseNotifyFile5")
        self.label_31 = QtWidgets.QLabel(self.groupBox_3)
        self.label_31.setGeometry(QtCore.QRect(10, 90, 47, 13))
        self.label_31.setObjectName("label_31")
        self.browseNotifyFile1 = QtWidgets.QPushButton(self.groupBox_3)
        self.browseNotifyFile1.setGeometry(QtCore.QRect(270, 50, 41, 20))
        self.browseNotifyFile1.setObjectName("browseNotifyFile1")
        self.label_30 = QtWidgets.QLabel(self.groupBox_3)
        self.label_30.setGeometry(QtCore.QRect(10, 60, 47, 13))
        self.label_30.setObjectName("label_30")
        self.notify1 = QtWidgets.QLineEdit(self.groupBox_3)
        self.notify1.setGeometry(QtCore.QRect(70, 50, 201, 20))
        self.notify1.setObjectName("notify1")
        self.browseNotifyFile1_2 = QtWidgets.QPushButton(self.groupBox_3)
        self.browseNotifyFile1_2.setGeometry(QtCore.QRect(520, 50, 41, 20))
        self.browseNotifyFile1_2.setObjectName("browseNotifyFile1_2")
        self.notify1_2 = QtWidgets.QLineEdit(self.groupBox_3)
        self.notify1_2.setGeometry(QtCore.QRect(320, 50, 201, 20))
        self.notify1_2.setObjectName("notify1_2")
        self.browseNotifyFile5_2 = QtWidgets.QPushButton(self.groupBox_3)
        self.browseNotifyFile5_2.setGeometry(QtCore.QRect(520, 80, 41, 20))
        self.browseNotifyFile5_2.setObjectName("browseNotifyFile5_2")
        self.notify5_2 = QtWidgets.QLineEdit(self.groupBox_3)
        self.notify5_2.setGeometry(QtCore.QRect(320, 80, 201, 20))
        self.notify5_2.setObjectName("notify5_2")
        self.differentByDays = QtWidgets.QCheckBox(self.groupBox_3)
        self.differentByDays.setGeometry(QtCore.QRect(320, 20, 201, 17))
        self.differentByDays.setObjectName("differentByDays")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_3.setTitle(_translate("Dialog", "Звуковые уведомления перед началом урока"))
        self.notifyBeforeRing.setText(_translate("Dialog", "Включить"))
        ...
        self.browseNotifyFile1_2.setText(_translate("Dialog", "..."))
        self.browseNotifyFile5_2.setText(_translate("Dialog", "..."))
        self.differentByDays.setText(_translate("Dialog", "По чётным числам другой звук"))
